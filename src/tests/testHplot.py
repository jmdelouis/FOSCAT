...
hp.mollview(d,cmap='jet',    nest=True,hold=False,sub=(2,3,1),min=-amp,max=amp,title='Model',norm='hist')
hp.mollview(di,cmap='jet',   nest=True,hold=False,sub=(2,3,2),min=-amp,max=amp,title='Noisy',norm='hist')
hp.mollview(s,cmap='jet',    nest=True,hold=False,sub=(2,3,3),min=-amp,max=amp,title='Cleanned',norm='hist')
hp.mollview(di-d,cmap='jet', nest=True,hold=False,sub=(2,3,4),min=-amp/4,max=amp/4,title='Noisy-Model')
hp.mollview(di-s,cmap='jet', nest=True,hold=False,sub=(2,3,5),min=-amp/4,max=amp/4,title='Noisy-Cleanned')
hp.mollview(s-d,cmap='jet',  nest=True,hold=False,sub=(2,3,6),min=-amp/4,max=amp/4,title='Cleanned-Model')
