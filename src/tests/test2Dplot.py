...
plt.figure(figsize=(12,8))
plt.subplot(1,2,1)
plt.imshow(ref[nx//2-nx//4:nx//2+nx//4,nx//2-nx//4:nx//2+nx//4],cmap='jet',origin='lower',vmin=-amp,vmax=amp)
plt.title('Input')
plt.subplot(1,2,2)
plt.imshow(omap[nx//2-nx//4:nx//2+nx//4,nx//2-nx//4:nx//2+nx//4],cmap='jet',origin='lower',vmin=-amp,vmax=amp)
plt.title('FoSCAT')
plt.show()
