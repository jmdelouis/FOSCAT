...
class scat_cov_map:
    ...
    def numpy(self):
        ...
        return scat_cov_map((self.P00.numpy()),
                        (self.C01.numpy()),
                        (self.C11.numpy()),
    ...
    def constant(self):
        ...
        return scat_cov_map(self.backend.constant(self.P00),
    ...
    def __add__(self, other):
        assert isinstance(other, float)  or isinstance(other, np.float32) or isinstance(other, int) or \
               isinstance(other, bool) or isinstance(other, scat_cov_map)

        if self.S1 is None:
            s1 = None
        else:
            if isinstance(other, scat_cov_map):
                if other.S1 is None:
                    s1=None
                else:
                    s1 = self.S1 + other.S1
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.doadd(self.P00,other.P00),
                            (self.C01 + other.C01),
                            c11,s1=s1, c10=c10,backend=self.backend)
        else:
            return scat_cov_map((self.P00 + other),
                            (self.C01 + other),
                            c11,s1=s1, c10=c10,backend=self.backend)
    ...
    def relu(self):
        ...
        return scat_cov_map(self.backend.bk_relu(self.P00),
    ...
    def __truediv__(self, other):
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.dodiv(self.P00,other.P00),
                            (self.C01 / other.C01),
                            c11,s1=s1, c10=c10,backend=self.backend)
        else:
            return scat_cov_map((self.P00 / other),
    ...
    def __rtruediv__(self, other):
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.dodiv(other.P00,self.P00),
                            (other.C01 / self.C01),
                            c11,s1=s1, c10=c10,backend=self.backend)
        else:
            return scat_cov_map((other/self.P00 ),
                            (other/self.C01 ),
                            (other/self.C11 ),
                            s1=s1, c10=c10,backend=self.backend)
    ...
    def __rsub__(self, other):
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.domin(other.P00,self.P00),
                            (other.C01 - self.C01),
                            c11,s1=s1, c10=c10,
                            backend=self.backend)
        else:
    ...
    def __sub__(self, other):
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.domin(self.P00,other.P00),
                            (self.C01 - other.C01),
                            c11,
                            s1=s1, c10=c10,backend=self.backend)
        else:
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, scat_cov_map):
            return scat_cov_map(self.domult(self.P00,other.P00),
    ...
    def interp(self,nscale,extend=True,constant=False):
        ...
        if nscale+2>self.P00.shape[2]:
            ...
            return scat_cov_map(self.P00,self.C01,self.C11,s1=self.S1,c10=self.C10,backend=self.backend)
        ...
        return scat_cov_map(self.backend.constant(p0),self.backend.constant(c01),
    ...
    def read(self, filename):
        ...
        return scat_cov_map(outlist[4], outlist[2], outlist[3], \
    ...
    def iso_mean(self,repeat=False):
        ...
        return scat_cov_map(P00, C01, C11, s1=S1, c10=C10,backend=self.backend)
...
class funct(FOC.FoCUS):
    ...
    def eval(self, image1, image2=None, mask=None, norm=None, Auto=True, Add_R45=False,out_size=None):
        ...
        if not cross:
            if Add_R45:
                return sc+scat_cov_map(P00, C01, C11, s1=S1,backend=self.backend)
            else:
                return scat_cov_map(P00, C01, C11, s1=S1,backend=self.backend)
        else:
            if Add_R45:
                return sc+scat_cov_map(P00, C01, C11, c10=C10,backend=self.backend)
            else:
                return scat_cov_map(P00, C01, C11, c10=C10,backend=self.backend)
    ...
    def square(self, x):
        if isinstance(x, scat_cov_map):
            if x.S1 is None:
                return scat_cov_map(self.backend.bk_square(self.backend.bk_abs(x.P00)),
    ...
    def sqrt(self, x):
        if isinstance(x, scat_cov_map):
            if x.S1 is None:
                return scat_cov_map(self.backend.bk_sqrt(self.backend.bk_abs(x.P00)),
    ...
    def ldiff(self,sig,x):
        ...
        if x.S1 is None:
            if x.C11 is not None:
                return scat_cov_map(x.domult(sig.P00,x.P00)*x.domult(sig.P00,x.P00),
    ...
    def eval_fast(self, image1, image2=None,mask=None,norm=None, Auto=True,Add_R45=False):
        ...
        return scat_cov_map(p0,  c01, c11, s1=s1,c10=c10,backend=self.backend)
