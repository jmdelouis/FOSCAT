...
class scat1D:
    ...
    def iso_mean(self,repeat=False):
        ...
        return scat1D(P00,self.S0,S1,S2,S2L,self.j1,self.j2,backend=self.backend)
    ...
    def iso_std(self,repeat=False):
        ...
        return scat1D(P00,self.backend.bk_abs(self.S0),S1,S2,S2L,self.j1,self.j2,backend=self.backend)
