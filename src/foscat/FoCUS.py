...
class FoCUS:
    ...
    def wst_cov(self, image,axis=0):
        ...
        for j3 in range(jmax):
            ...
            real_product=self.reduce_dim(self.swapaxes(self.swapaxes(self.swapaxes(real_product,-3,-1),-4,-2),-5,-3),-5)
            imag_product=self.reduce_dim(self.swapaxes(self.swapaxes(self.swapaxes(imag_product,-3,-1),-4,-2),-5,-3),-5)
            ...
            P11_Norm=self.reduce_dim(self.swapaxes(self.swapaxes(self.swapaxes(P11_Norm,-3,-1),-4,-2),-5,-3),-5)
